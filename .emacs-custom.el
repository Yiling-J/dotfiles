(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-modeline use-package lsp-ui yasnippet lsp-mode go-mode vterm magit-todos org-jira csv-mode docker-tramp json-mode markdown-mode git-gutter-fringe pythonic prettier-js add-node-modules-path rust-mode editorconfig expand-region flycheck-color-mode-line flycheck company-anaconda anaconda-mode counsel-projectile counsel tangotango-theme dumb-jump nyan-mode zenburn-theme powerline neotree all-the-icons magit helm-ebdb))
